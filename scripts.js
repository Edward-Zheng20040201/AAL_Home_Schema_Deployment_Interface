...
function updateDebugPanel() {
    document.getElementById('debug-transformScale').textContent = transformScale.toFixed(2);
    document.getElementById('debug-offsetX').textContent = offsetX.toFixed(2);
    document.getElementById('debug-offsetY').textContent = offsetY.toFixed(2);
}
